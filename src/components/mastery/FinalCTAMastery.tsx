        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 sm:space-y-10 relative z-10">
            ...
            {[
              {
                ...
                title: "Bao gồm trong Pro",
                desc: "Không bán lẻ — chỉ có cho thành viên Freedom Builder Pro",
              },
              {
                icon: "card_giftcard",
                title: "6 Bonus độc quyền",
                desc: "Tặng kèm miễn phí khi bạn vào gói Pro",
              },
              {
                icon: "shield",
          ...
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-baseline gap-3">
              <span className="text-lg sm:text-2xl text-on-surface-variant/70 font-black line-through decoration-red-500 decoration-[3px] sm:decoration-4">
                5.000.000đ
              </span>
