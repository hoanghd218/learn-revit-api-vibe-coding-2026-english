...
function FlowArrowVertical({ delayClass = "", label }: { delayClass?: string; label?: string }) {
  return (
    <div className="flex flex-col items-center">
      <div className="flow-connector-v flow-arrow-down w-px h-8 sm:h-12 bg-linear-to-b from-primary/40 to-primary/15 relative">
...
function MemberFlowArrow({ index }: { index: number }) {
  ...
  return (
    <div className="flex justify-center">
      <div className={`flow-connector-v w-px h-4 sm:h-6 bg-linear-to-b from-primary/25 to-primary/5 relative`}>
...
export default function AICompany({ builtOn = "OPENCLAW", builtOnSubtitle }: AICompanyProps = {}) {
  return (
        ...
        <ScrollReveal>
          <div className="text-center mb-10 sm:mb-16">
            ...
            <p className="text-base sm:text-xl text-on-surface-variant max-w-2xl mx-auto">
              {builtOnSubtitle ?? "Một đội ngũ AI Agents vận hành 24/7 — thay thế cả phòng ban với chi phí gần bằng 0"}
            </p>
          </div>
        </ScrollReveal>
